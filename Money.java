...
public class Money {
    ...
    private void validate(Fraction fraction, Currency currency) {
        if (fraction == null || currency == null)
    ...
    private void validate(int integerValue, int cents) {
        if (integerValue < 0 || cents < 0 || cents > 100)
            throw new IllegalArgumentException("Bad value:" + integerValue + "." + cents + ". Permissible value should be greater than 0 and cents should be less 100!");
    }

    private void validate(double value) {
        if (value < 0)
            throw new IllegalArgumentException("Bad value:" + value + ". Permissible value should be greater than 0!");
    }
